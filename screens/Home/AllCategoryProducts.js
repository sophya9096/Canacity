...
function AllCategoryProducts({navigation}) {
  const [allproducts, setBlogs] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const data = await fetch(
        'https://canacitycannabis.ca/wp-json/wc/v3/products?per_page=100&consumer_key=ck_2478a5170f75f45dcf9514126067be2dab2b1b94&consumer_secret=cs_023ef065e096a004f1334c289f8498863142a356',
      );
    ...
    <Container
      ...
      <View
        ...
        <View
          ...
          <Text style={{color: '#bf1f1f', fontSize: hp('2.1%')}}>All Products</Text>
          <TouchableOpacity
                transparent
                style={{justifyContent: 'center', paddingRight: wp('1.5%')}}

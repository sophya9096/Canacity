...
function Category3({navigation}) {
  const [sativa, setBlogs3data3] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const data3 = await fetch(
        'https://canacitycannabis.ca/wp-json/wc/v3/products?category=19&consumer_key=ck_2478a5170f75f45dcf9514126067be2dab2b1b94&consumer_secret=cs_023ef065e096a004f1334c289f8498863142a356&per_page=100',
      );

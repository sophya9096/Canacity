...
function Category4({navigation}) {
  const [highcbd, setBlogs3data3] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const data3 = await fetch(
        'https://canacitycannabis.ca/wp-json/wc/v3/products?category=23&consumer_key=ck_2478a5170f75f45dcf9514126067be2dab2b1b94&consumer_secret=cs_023ef065e096a004f1334c289f8498863142a356&per_page=100',
      );
      const newData3 = await data3.json();
      setBlogs3data3(newData3);
      setLoading(false);
      // console.log(data3);
    };
    fetchData();
    ...
    <Container
      ...
      <View
        ...
        <View
          ...
          <Text style={{color: '#bf1f1f', fontSize: hp('2.1%')}}>High CBD</Text>
          <TouchableOpacity
                transparent
                style={{justifyContent: 'center', paddingRight: wp('1.5%')}}
